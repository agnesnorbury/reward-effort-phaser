...
export default class ChoicePanel {
    constructor(scene, x, y, trialReward1, trialEffort1, trialReward2, trialEffort2) {
    this.scene = scene;
    
    // set properties of the panel (text content and colours)    
    var titleTxt; var mainTxt; var buttonTxt;
    titleTxt = 'You have a choice!';
    mainTxt = (' Which route would you like to \n'+
               ' take across the river? \n\n'+
              //'  high route:         low route:  \n'+                
              '[color=#FFD700]'+trialReward1+' coins[/color]         '+
